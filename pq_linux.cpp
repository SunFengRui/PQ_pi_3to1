...
void pq_linux::update(void)
{
    ...
    //A
    {
        ...
        sprintf(tmp, "%.7f", active_power_meter_tmp);
        ui->PT->setText(tmp);
        //
        ...
        sprintf(tmp, "%.7f", reactive_power_meter_tmp);
        ui->QT->setText(tmp);
        //
        ...
        //
        sprintf(tmp, "%.7f", fuzhi_a[1]);
        ui->V_jibofuzhi->setText(tmp);
        //
        sprintf(tmp, "%.7f", fuzhi_a_cur[1]);
        ui->I_jibofuzhi->setText(tmp);
        //
        sprintf(tmp, "%.3f", fuzhi_a[1] / fuzhi_a_cur[1]);
...

    {
        ...
        sprintf(tmp, "%.7f", fuzhi_b[1]);
        ui->B_V_jibofuzhi->setText(tmp);
        sprintf(tmp, "%.7f", fuzhi_b_cur[1]);
        ui->B_I_jibofuzhi->setText(tmp);
        sprintf(tmp, "%.3f", fuzhi_b[1] / fuzhi_b_cur[1]);
    ...
    }
    {
        ...
        sprintf(tmp, "%.7f", fuzhi_c[1]);
        ui->C_V_jibofuzhi->setText(tmp);
        sprintf(tmp, "%.7f", fuzhi_c_cur[1]);
        ui->C_I_jibofuzhi->setText(tmp);
        sprintf(tmp, "%.3f", fuzhi_c[1] / fuzhi_c_cur[1]);
...
//if ((C_VoltagedipDurationLastTime > 20)||(C_VoltagedipDurationLastTime==0))
    ...
    sprintf(tmp, "%.7f", uneg_param1);
    ui->uneg_param1->setText(tmp);
    sprintf(tmp, "%.7f", uneg_param2);
